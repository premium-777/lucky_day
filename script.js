...
const testimonials = [
     {
        text: "VIP-доступ к 25-му часу изменил мою жизнь! Правда, час работает только 29 февраля, но я уже запланировал на этот день столько дел!",
        author: "Андрей Т., тайм-менеджер мечты"
    },
    {
        text: "Умная зубочистка - это прорыв! Теперь я знаю, что чистил зубы вчера в 21:47. Жена говорит, что я стал помешанным на статистике.",
        author: "Михаил З., фанат данных"
    },
    {
        text: "Алгоритм предсказания прошлого угадал, что вчера я ел овсянку! Правда, пришлось дать доступ ко всем камерам в доме, но оно того стоило.",
        author: "Елена С., любительница технологий"
    },
    {
        text: "Эко-пиксель делает мой экран на 0.000001% экологичнее! Чувствую себя настоящим защитником планеты, ничего при этом не делая.",
        author: "Олег Э., эко-активист"
    },
    {
